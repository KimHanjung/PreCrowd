...
exports.pass = async (req, res) => {
    try{
        ...
        if(pass == 1){
            console.log("PASS!!!\n");
            sql = "SELECT t.Task_data_table_name, t.Task_data_table_schema, p.Parsing_file_name, p.Data_file "+
            ...
            var path = "./src/downloads/" + file_name;
            console.log(data_file);
            fs.writeFileSync(path, data_file);
            ...
            */
            ...
            await sequelize.query(sql, {
                replacements : [path, task_data_table_name],
                type: QueryTypes.RAW,
